...
import com.easemob.chatuidemo.activity.SearchingConversationActivity;
...
public class SearchingConversationAdapter extends BaseAdapter{
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message message) {
			...
			case HANDLER_MESSAGE_SELECT_LAST:
				if (activity instanceof SearchingConversationActivity) {
					ListView listView = ((SearchingConversationActivity)activity).getListView();
			...
			public boolean onLongClick(View v) {
				activity.startActivityForResult(
						(new Intent(activity, ContextMenu.class)).putExtra("position", position).putExtra("type",
								EMMessage.Type.TXT.ordinal()), SearchingConversationActivity.REQUEST_CODE_CONTEXT_MENU);
				return true;
			}
		});
	...
	private void handleImageMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		holder.iv.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				activity.startActivityForResult(
						(new Intent(activity, ContextMenu.class)).putExtra("position", position).putExtra("type",
								EMMessage.Type.IMAGE.ordinal()), SearchingConversationActivity.REQUEST_CODE_CONTEXT_MENU);
				return true;
			}
		});
	...
	private void handleVideoMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		holder.iv.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				activity.startActivityForResult(
						new Intent(activity, ContextMenu.class).putExtra("position", position).putExtra("type",
								EMMessage.Type.VIDEO.ordinal()), SearchingConversationActivity.REQUEST_CODE_CONTEXT_MENU);
				return true;
			}
		});
	...
	private void handleVoiceMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		holder.iv.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				activity.startActivityForResult(
						(new Intent(activity, ContextMenu.class)).putExtra("position", position).putExtra("type",
								EMMessage.Type.VOICE.ordinal()), SearchingConversationActivity.REQUEST_CODE_CONTEXT_MENU);
				return true;
			}
		});
		if (((SearchingConversationActivity)activity).playMsgId != null
				&& ((SearchingConversationActivity)activity).playMsgId.equals(message
	...
	private void handleLocationMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		locationView.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				activity.startActivityForResult(
						(new Intent(activity, ContextMenu.class)).putExtra("position", position).putExtra("type",
								EMMessage.Type.LOCATION.ordinal()), SearchingConversationActivity.REQUEST_CODE_CONTEXT_MENU);
				return false;
			}
		});
	...
	private void sendPictureMessage(final EMMessage message, final ViewHolder holder) {
		try {
			...
			final long start = System.currentTimeMillis();
			// if (chatType == SearchingConversationActivity.CHATTYPE_SINGLE) {
			EMChatManager.getInstance().sendMessage(message, new EMCallBack() {
